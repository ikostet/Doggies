...
import com.example.doggies.presentation.flow.destinations.CatalogScreenDestination
import com.example.doggies.presentation.theme.PADDING_20
import com.example.doggies.presentation.theme.PADDING_40
    ...
    Row(
        ...
        if (pagerState.currentPage == 2) {
            Button(
                ...
                Text(text = stringResource(id = R.string.go_catalog))
            }
        }
    }
}
